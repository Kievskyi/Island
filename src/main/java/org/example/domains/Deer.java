...
public class Deer extends Herbivore {
    ...
    private String kind_of_animal = "Deer";
    private String icon = AnimalIcons.DEER.getIcon();
...
//            }
    ...
    public void reproduce(Animal animal, int width, int length) {
        ...
        areaData.getArea()[randomWidth][randomLength].setAnimals_in_cell(new AnimalFactory().create(AnimalType.DEER));
    }
